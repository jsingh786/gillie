...
@section('pageTitle', 'Manage Banners')
@section('head')
...
@section('content')
    <div ng-controller="bannerController">
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header data-table-hdr">Manage Banners</h2>
                </div>
            </div>
            <a href="{{ url('admin/banner/add-banner') }}" class="btn btn-primary" type="submit">Add Banners</a>
