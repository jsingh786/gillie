...
class regions extends \App\Entity\regions implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'id', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'code', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'name', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'created_at', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'updated_at', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'users', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'events', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'forum', '' . "\0" . 'App\\Entity\\regions' . "\0" . 'community'];
        }
