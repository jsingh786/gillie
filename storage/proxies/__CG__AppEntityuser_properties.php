 ...
 */
class user_properties extends \App\Entity\user_properties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\user_properties' . "\0" . 'id', '' . "\0" . 'App\\Entity\\user_properties' . "\0" . 'users', '' . "\0" . 'App\\Entity\\user_properties' . "\0" . 'properties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (user_properties $proxy) {
