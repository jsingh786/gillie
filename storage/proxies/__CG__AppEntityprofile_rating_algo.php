 ...
 */
class profile_rating_algo extends \App\Entity\profile_rating_algo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\profile_rating_algo' . "\0" . 'id', '' . "\0" . 'App\\Entity\\profile_rating_algo' . "\0" . 'star', '' . "\0" . 'App\\Entity\\profile_rating_algo' . "\0" . 'points', '' . "\0" . 'App\\Entity\\profile_rating_algo' . "\0" . 'created_at', '' . "\0" . 'App\\Entity\\profile_rating_algo' . "\0" . 'updated_at', '' . "\0" . 'App\\Entity\\profile_rating_algo' . "\0" . 'deleted_at'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (profile_rating_algo $proxy) {
