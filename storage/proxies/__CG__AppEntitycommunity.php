...
class community extends \App\Entity\community implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\community' . "\0" . 'id', '' . "\0" . 'App\\Entity\\community' . "\0" . 'code', '' . "\0" . 'App\\Entity\\community' . "\0" . 'name', '' . "\0" . 'App\\Entity\\community' . "\0" . 'created_at', '' . "\0" . 'App\\Entity\\community' . "\0" . 'updated_at', '' . "\0" . 'App\\Entity\\community' . "\0" . 'regions', '' . "\0" . 'App\\Entity\\community' . "\0" . 'forum'];
        }
