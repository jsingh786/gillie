 ...
 */
class user_species extends \App\Entity\user_species implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\user_species' . "\0" . 'id', '' . "\0" . 'App\\Entity\\user_species' . "\0" . 'users', '' . "\0" . 'App\\Entity\\user_species' . "\0" . 'species'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (user_species $proxy) {
