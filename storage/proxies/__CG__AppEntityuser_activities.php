 ...
 */
class user_activities extends \App\Entity\user_activities implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\user_activities' . "\0" . 'id', '' . "\0" . 'App\\Entity\\user_activities' . "\0" . 'users', '' . "\0" . 'App\\Entity\\user_activities' . "\0" . 'activities'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (user_activities $proxy) {
