...
class album extends \App\Entity\album implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\album' . "\0" . 'id', '' . "\0" . 'App\\Entity\\album' . "\0" . 'display_name', '' . "\0" . 'App\\Entity\\album' . "\0" . 'name', '' . "\0" . 'App\\Entity\\album' . "\0" . 'created_at', '' . "\0" . 'App\\Entity\\album' . "\0" . 'updated_at', '' . "\0" . 'App\\Entity\\album' . "\0" . 'deleted_at', '' . "\0" . 'App\\Entity\\album' . "\0" . 'photos', '' . "\0" . 'App\\Entity\\album' . "\0" . 'users'];
        }
    ...
    public function getDisplay_name()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDisplay_name', []);

        return parent::getDisplay_name();
    }
    ...
    public function setDisplay_name($display_name)
    {
        ...
        return parent::setDisplay_name($display_name);
    }
