 ...
 */
class forum_comments extends \App\Entity\forum_comments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'id', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'message', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'status', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'created_at', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'updated_at', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'forum', '' . "\0" . 'App\\Entity\\forum_comments' . "\0" . 'users'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (forum_comments $proxy) {
