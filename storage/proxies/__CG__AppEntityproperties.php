 ...
 */
class properties extends \App\Entity\properties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\properties' . "\0" . 'id', '' . "\0" . 'App\\Entity\\properties' . "\0" . 'name', '' . "\0" . 'App\\Entity\\properties' . "\0" . 'userProperties'];
        }
